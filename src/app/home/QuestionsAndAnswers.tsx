...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          PolishedProfile saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets PolishedProfile apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than PolishedProfile, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, PolishedProfile
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. PolishedProfile is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, PolishedProfile intentionally only offers
          ...
          like references. Additionally, PolishedProfile only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. PolishedProfile is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, PolishedProfile believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          PolishedProfile doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created PolishedProfile and why?",
    answer: (
      <p>
  ...
  {
    question: "Q4. How can I support PolishedProfile?",
    answer: (
      <>
        <p>
